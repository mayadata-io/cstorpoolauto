...
curl https://raw.githubusercontent.com/mayadata-io/storage-provisioner/master/deploy/kubernetes/storage_crd.yaml
...
echo -e "\n++ Applying openebs"
curl https://openebs.github.io/charts/openebs-operator-1.5.0.yaml
