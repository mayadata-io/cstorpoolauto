...
// GenericHookRequest is the object sent as JSON to the sync hook.
type GenericHookRequest struct {
	...
	Attachments AnyUnstructRegistry `json:"attachments"`
...
// GenericHookResponse is the expected format of the JSON response
// from the sync hook.
type GenericHookResponse struct {
